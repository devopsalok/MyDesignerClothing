...
public abstract class Optional<T> implements Serializable {
  ...
  public abstract <V> Optional<V> bind(final Optional<V> optional, final Function<? super T, V> binder);

  public abstract <V> V map(final Function<? super T, V> ifPresent, final V defaultValue);
  ...
  public static Optional<String> fromString(String string) {
